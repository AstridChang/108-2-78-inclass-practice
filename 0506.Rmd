...
str_extract_all(
  c("民國108年12月5日","民國98年10月5日"),
  "(?<=民國)[0-9]{2,3}(?=年)" 
) # 回傳list(差別在有all)  #98: str_function(string,pattern)
...
```{r}
studentIds <- c("410873029","410773005","410772035","410562123","410473108") #410473108會有風險 因為有108出現所以會被選到 但其實並不是我們要的位置
# 取出學號中的入學屆為107或108
