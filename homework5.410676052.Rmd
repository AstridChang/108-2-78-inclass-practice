...
a01<-sort(as.integer(levels(studentHeights$`學年度`)))
a02<-as.character(a01)

b01<-sort(as.integer(levels(studentHeights$`年齡`)))
b02<-as.character(b01)
...
currentsLevels
school <- levels(factor(currentsLevels))
