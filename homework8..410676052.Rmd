...
```{r ans11}
str_detect(ntpc_building_info$name,"停車場") -> picked

ntpc_building_info$name[picked] -> ntpc_building_parking
...
```{r ans12}
no_found <- function(keyword){
  if(any(keyword!=c("員工汽車停車場","員工汽車停車場","公務汽車停車場","來賓停車場","教育研究發展科",
                    "總收文","話務中心","按摩坊","洗衣坊","郵局","銀行","麵包店","美容室","花卉中心",
                    "便利商店","理髮廳","大廳","勞工局","社會局","城鄉發展局","哺集乳室","餐飲區",
                    "聯合服務中心","大廳","新希望關懷中心","工務局","社會局","監控中心","警衛室",
                    "幼兒園" ))){
    warning("No Found")
         }
}
