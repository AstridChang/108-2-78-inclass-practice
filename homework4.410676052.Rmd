...
#可嘗試str_extract_all(twoNames, "段(兄弟|兄)") #括號內兄&兄弟位置調換
```
...
picked_p2 <- (semiGodsSemiDevils$data[[1]]$section == "p2")
context_picked <- semiGodsSemiDevils$data[[1]]$text[picked_p2]

# or
semiGodsSemiDevils$data[[1]][3,2] -> context_picked
...
```{r ans24}
first <- unlist(mention_duan)
table_duan <- table(first)
